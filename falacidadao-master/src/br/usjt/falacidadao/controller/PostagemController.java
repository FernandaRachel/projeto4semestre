...
public class PostagemController {
	...
	@Autowired
	public PostagemController(PostagemService servicePostagem, AreaService serviceArea,
			AreaPropertyEditor areaPropertyEditor, UsuarioService usuarioService, ComentarioService comentarioService) {
	...
	public String crudpostagem(@Valid @ModelAttribute("postagem") Postagem postagem, BindingResult result, Model model,
			@RequestParam("fileName") MultipartFile fileName, HttpSession session) throws IOException {
		if (!result.hasErrors()) {
